    ...
    <div className="home-page animate-fade-in">
      ...
      <section className="hero-split">
        <div className="hero-side hero-sheldon theme-turtle">
          <div className="hero-content">
            <div className="hero-image-container">
              <img src="/sheldon_tortoise_adorable_worker_1772080468357.png" alt="Sheldon the Tortoise Mascot" className="hero-mascot-img" />
            </div>
        ...
        <div className="hero-side hero-hariette theme-hare">
          <div className="hero-content">
            <div className="hero-image-container">
              <img src="/hariette_hare_final.png" alt="Hariette the Hare Mascot" className="hero-mascot-img" />
            </div>
          ...
          <div className="philosophy-grid">
            <div className="philosophy-text">
              ...
              <ul className="philosophy-list">
                ...
                <li><img src="/art turtle.png" alt="Tortoise" style={{ width: '24px', height: '24px', display: 'inline-block', verticalAlign: 'middle', marginRight: '8px' }} /> We celebrate your finish line!</li>
              </ul>
            ...
            <div className="philosophy-image shadow-soft">
              ...
              <img src="/watermarked-10bc01e4-3ff5-4e21-8099-ae406a35f2d9.jpg" alt="Diment Attorneys" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
          </div>
        </div>
      </section>
